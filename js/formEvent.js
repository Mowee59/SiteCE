    ...
    var formEvent = (function () {
        ...
        //
        //                // Le groupe lieu
        //                var locationEventGroup = document.createElement('div');
        //                locationEventGroup.className = "form-group";
        //                var label_location = document.createElement('label');
        //                label_location.className = 'input-title';
        //                label_location.htmlFor = "lieuEvent";
        //                label_location.innerHTML = "Lieu";
        //                var i_location_event = document.createElement('input');
        //                i_location_event.type = 'text';
        //                i_location_event.id = "lieuEvent";
        //                i_location_event.name = "lieuEvent";
        //                i_location_event.className = "form-control";
        //                i_location_event.placeholder = "Ex : San Francisco";
        //                var invalid_location = document.createElement('span');
        //                invalid_location.className = "invalid";
        //                invalid_location.innerHTML = "3 caractères minimum";
        //                locationEventGroup.appendChild(label_location);
        //                locationEventGroup.appendChild(i_location_event);
        //                locationEventGroup.appendChild(invalid_location);
        //                form.appendChild(locationEventGroup);
        //
        //                form.appendChild(document.createElement('hr'));
        //
        //                // Le groupe catégorie
        ...
        //                select_jour.className = "form-control";
        ...
        //                invalid_jour.className = "invalid";
        ...
        //                select_mois.className = "form-control";
        ...
        //                invalid_mois.className = "invalid";
        ...
        //                select_annee.className = "form-control";
        ...
        //                desc_group.appendChild(invalid_desc);
